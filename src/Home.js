...
const Home = () => {
  ...
  const handleMat = () => {
    const integerProductId = parseInt('1', 10);
    navigate(`/connexion${integerProductId}`);
    ...
    <li>
          ...
          <div style={textColumnStyle}>
            ...
            <Link to="./connexion" style={{ textDecoration: 'none', color: 'blue' }} onClick={ handleMat('material')}>Consulter tout les Matériaux ...</Link>
    ...
    <li>
          ...
          <h2>Produits</h2>
            ...
            <a href="/connexion/produit" onClick={localStorage.setItem('', '/produit')} style={linkStyle}>Consulter tout les Produits ...</a>
          </div>
    ...
    <li>
      ...
      <img src={OuvragePhoto} alt="Image des ouvrages"  style={{ width: '35%', height: '35%' }} />
          ...
          <h2>Ouvrages</h2>
            ...
            <a href="/connexion/ouvrage" onClick={localStorage.setItem('', '/ouvrage')} style={linkStyle}>Consulter tout les Ouvrages ...</a>
          </div>
        </div>
    </li>
    ...
    <li>
          ...
          <p>
            ...
            <a href="/connexion/pathologie" onClick={localStorage.setItem('', '/pathologie')} style={linkStyle}>Consulter tout les Pathologies ...</a>
          </div>
    ...
    <li>
      ...
      <div style={sectionStyle}>
          ...
          <p>
            ...
            <a href="/connexion/monument" onClick={localStorage.setItem('', '/monument')} style={linkStyle}>Consulter tout les Monuments ...</a>
          </div>
        </div>
