...
function Categorie1() {
  ...
  <div className='catlist'>
    <div className='catIt' style={{ border: '2px solid #27AE60' , borderRadius: '20px'}}>
      <Link to="/categorie1" style={{ textDecoration: 'none' }}>
        <p style={{ color: '#338AFF', textAlign: 'center' }}>Matériaux à base de terre</p>
      </Link>
    </div>
    <div className='catIt' style={{ border: '2px solid #2C3E50' , borderRadius: '20px' }}>
      <Link to="/categorie2" style={{ textDecoration: 'none' }}>
        <p style={{ color: '#338AFF', textAlign: 'center' }}>Minéraux et Roches</p>
      </Link>
    </div>
    <div className='catIt' style={{ border: '2px solid #F39C12' }}>
      <Link to="/categorie3" style={{ textDecoration: 'none' }}>
        <p style={{ color: '#338AFF', textAlign: 'center' }}>   Bois     </p>
      </Link>
    </div>
  </div>
</div>
  ...
  <span className='Path' style={{ color: 'blue' }}>&gt;</span> {/* Utilisation de span pour le symbole ">" */}
  <Link to="/categorie1" style={{ color: 'blue', textDecoration: 'none' }}>Matériaux à base de terre</Link> {/* Lien vers la page Monument */}
</div>
    ...
    <div className='catbox'>
      <input  type="checkbox"  checked={isChecked1}  onChange={handleCheckbox1Change} />
      <label htmlFor="checkbox">Place1</label>
    </div>
    <div className='catbox'>
      <input  type="checkbox"  checked={isChecked2}  onChange={handleCheckbox2Change} />
      <label htmlFor="checkbox">Place2</label>
    </div>
    <div className='catbox'>
      <input  type="checkbox"  checked={isChecked3}  onChange={handleCheckbox3Change} />
      <label htmlFor="checkbox">Place3</label>
    </div>   
    ...
    <div className='catbox'>
      <input  type="checkbox"  checked={isChecked1}  onChange={handleCheckbox1Change} />
      <label htmlFor="checkbox">Couleur1</label>
    </div>
    <div className='catbox'>
      <input  type="checkbox"  checked={isChecked2}  onChange={handleCheckbox2Change} />
      <label htmlFor="checkbox">Couleur2</label>
    </div>
    <div className='catbox'>
      <input  type="checkbox"  checked={isChecked3}  onChange={handleCheckbox3Change} />
      <label htmlFor="checkbox">Couleur3</label>
    </div>   
    </div>  
          <div className='lineFBar'></div>
